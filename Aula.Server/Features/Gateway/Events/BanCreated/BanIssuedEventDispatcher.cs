...
internal sealed class BanIssuedEventDispatcher : INotificationHandler<BanIssuedEvent>
{
	...
	public BanIssuedEventDispatcher(GatewayManager gatewayManager, UserManager userManager)
	{
	...
	public async Task Handle(BanIssuedEvent notification, CancellationToken cancellationToken)
	{
		...
		{
			Operation = OperationType.Dispatch, Event = EventType.BanIssued, Data = notification.Ban.ToBanData(),
		};
