...
internal static class SendMessageRateLimitingPolicy
{
	internal const String Name = nameof(SendMessageRateLimitingPolicy);

	internal static void Add(IServiceCollection services)
	{
		_ = services.AddOptions<RateLimitOptions>(Name)
			.BindConfiguration($"RateLimiting:{nameof(SendMessage)}")
